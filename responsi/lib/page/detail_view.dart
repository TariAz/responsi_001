...
import 'package:responsi/models/detail_meals.dart';
import 'package:responsi/services/api_data_source.dart';
import 'package:url_launcher/url_launcher.dart';

class DetailView extends StatefulWidget {
  final String idMeals;
  const DetailView({super.key, required this.idMeals});

  @override
  State<DetailView> createState() => _DetailView();
}
